<%-- 
    Document   : addStudent
    Created on : Nov 13, 2014, 5:48:20 PM
    Author     : Sara
--%>
...
<html>
    <head>
        ...
        <title>New Student Admit</title>
    </head>
    <body  bgcolor="#E6E6FA">
          <img src = "chattahoochee.png" alt = "" width ="200" height="200"/>
         <form name="changeinfo" method="post" 
         action="http://localhost:8084/StudentRegistration/addStudServlet">
           
        <h1><font color="#4B8A08">Student</font></h1>
        <%
        ...
        <br/>
        <input type ="submit" name ="sb" value ="Find">
