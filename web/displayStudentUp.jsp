<%-- 
    Document   : displayStudentUp
    Created on : Nov 21, 2014, 8:30:16 PM
    Author     : Sara
--%>
...
<html>
    <head>
        ...
        <title>View and Updated</title>
    </head>
     <body  bgcolor="#E6E6FA">
        
        <h1>Update Student Information</h1>
          <img src = "chattahoochee.png" alt = "" width ="200" height="200"/>
         <form name="update" method="post" action="http://localhost:8084/StudentRegistration/studentUpServlet">
